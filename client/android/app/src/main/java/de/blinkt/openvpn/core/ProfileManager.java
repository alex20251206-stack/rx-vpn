        ...
        try {
            ...
            if (encryptedPath.exists()) {
                try {
                    ...
                    // stale encrypted file entry, try legacy/plain fallback
                    if (encryptedPath.exists()) encryptedPath.delete();
                ...
                try {
                    ...
                    // stale old encrypted file entry, remove and fallback
                    if (encryptedPathOld.exists()) encryptedPathOld.delete();
                    vpInput = context.openFileInput(vpnentry + ".vp");
                }
            } else {
                vpInput = context.openFileInput(vpnentry + ".vp");
